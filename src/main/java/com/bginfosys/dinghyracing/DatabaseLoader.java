...
//		Race r1 = new Race("Scorpion A", now.plusMinutes(1L), dc1, Duration.ofMinutes(45), 5);
		Race r1 = new Race("Scorpion A", now.plusMinutes(0L), dc1, Duration.ofMinutes(45), 5, RaceType.FLEET, StartType.CSCCLUBSTART);
		Race r2 = new Race("Graduate A", now.plusMinutes(6L), dc2, Duration.ofMinutes(35), 4, RaceType.FLEET, StartType.CSCCLUBSTART);
		Race r3 = new Race("Comet A", now.plusMinutes(11L), dc3, Duration.ofMinutes(35), 4, RaceType.FLEET, StartType.CSCCLUBSTART);
//		Race r4 = new Race("Handicap A", now.plusMinutes(16L), null, Duration.ofMinutes(35), 4);
		Race r4 = new Race("Handicap A", now.plusMinutes(1L), null, Duration.ofMinutes(35), 4, RaceType.FLEET, StartType.CSCCLUBSTART);
